...
export default function Support() {
    const [ishvr,sethvr]=useState(false);
    const order=[
    {
        img:icon.trackOrder,
        tag:"Track Order"
    ...
    <div className="h-auto">
      ...
      <div className="h-screen mt-40">
        <div className="h-full flex flex-col gap-20 items-center justify-center">
            <div className="flex gap-30">  
                <div className="w-50 flex flex-col items-center gap-6">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <span className="text-center">Click the chat icon to start a chat.</span>
                    </div>
                </div>
                <div className="w-50 flex flex-col items-center gap-6">
                    <span>
            ...
            <div className="h-full grid grid-cols-4 gap-20">
                {
                    order.map((ord)=>(
                            <div 
                    className="h-36 w-40 flex flex-col items-center justify-around border rounded-xl  border-gray-200 "
                    onMouseEnter={(e)=>{e.currentTarget(sethvr(true))}}
                ...
                > 
                    ...
                    <p className="font-semibold relative  ">
                        ...
                        <span className={` h-[2px] rounded-lg bg-black block  ${ishvr? 'w-full  duration-300 ease-in-out ':'w-0 duration-300 ease-out'} `}></span>
                    </p>
                </div>
                    ))
                }
