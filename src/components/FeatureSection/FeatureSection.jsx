...
export default function FeatureSection(){
    ...
    return(
        <div className="h-96 flex flex-col justify-around sm:px-10">
            <div className="px-10 sm:px-0" >
                <Features/>
            </div>
            <div className="flex flex-col justify-center items-center text-center gap-5">
                <span className="text-lg sm:text-2xl font-bold">Can't decide? Take a short quiz to find the perfect fit.</span>
