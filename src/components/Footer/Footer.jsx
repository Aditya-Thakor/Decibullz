  ...
  return (
    <div className="sm:h-auto xl:h-screen flex flex-col sm:gap-20 bg-black text-white px-5 py-10 sm:px-12 sm:py-14">
      <div className=" h-3/4  grid gap-10 sm:gap-10 lg:gap-10 grid-cols-12">
        <div className="col-span-10 sm:col-span-12 lg:col-span-5 flex flex-col gap-10 sm:gap-7 lg:gap-10 ">
          ...
          <div className="w-full relative flex items-center">
            <input
              type="email"
              placeholder="E-mail"
              className="p-4 border border-stone-800 focus:rounded-none w-full"
            />
            <ChevronRight className="bg-stone-900 p-1 rounded-full relative right-10 hover:bg-white hover:text-black" />
          </div>
        </div>

        <div className="col-span-10 sm:col-span-12 lg:col-span-7 grid gap-5 sm:gap-16 lg:gap-12 grid-cols-12">
      ...
      <div className="h-1/4 sm:h-1/6 grid gap-5 sm:gap-0  grid-cols-12 pt-7 sm:pt-0">
        ...
        <div className="col-span-10 sm:col-span-6 flex flex-col gap-5 sm:gap-0 items-start sm:items-end justify-between  ">
